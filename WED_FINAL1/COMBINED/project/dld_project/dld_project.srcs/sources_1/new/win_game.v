    ...
    always @(posedge clk_d) begin
        if (video_on) begin
            ...
            if (
                ...
                // w conditions
                (pixel_x >= 250 && pixel_x <= 270 && pixel_y >= 270 && pixel_y <= 410) || // Left vertical bar of M
                (pixel_x >= 295 && pixel_x <= 315 && pixel_y >= 270 && pixel_y <= 410) || // Middle bar of M
                (pixel_x >= 340 && pixel_x <= 365 && pixel_y >= 270 && pixel_y <= 410) || //
                (pixel_x >= 250 && pixel_x <= 365 && pixel_y >= 390 && pixel_y <= 410) ||
//               // i conditions
                (pixel_x >= 395 && pixel_x <= 500 && pixel_y >= 270 && pixel_y <= 290) || // Left diagonal of V
                (pixel_x >= 395 && pixel_x <= 500 && pixel_y >= 390 && pixel_y <= 410) || // Right diagonal of V
                (pixel_x >= 437 && pixel_x <= 457 && pixel_y >= 270 && pixel_y <= 410) || // Bottom tip of V
                
//               // n conditions
                (pixel_x >= 520 && pixel_x <= 625 && pixel_y >= 270 && pixel_y <= 290) || // Top bar of I
                (pixel_x >= 520 && pixel_x <= 540 && pixel_y >= 270 && pixel_y <= 410) ||                
                (pixel_x >= 605 && pixel_x <= 625 && pixel_y >= 270 && pixel_y <= 410)  
